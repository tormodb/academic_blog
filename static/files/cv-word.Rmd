...
curpos <- tribble(
  ...
  "2025-", "Research director, RKBU Vest, NORCE, Norway",
  "2025-", "Professor (20%), Faculty of Psychology, University of Bergen, Norway",
  "2020-2025", "Professor, Faculty of Psychology, University of Bergen, Norway",
  "2018-2025", "Senior Researcher (20% position), Uni Research Health, Bergen, Norway",
...
proj <- tribble(
  ...
  "2023-2026", "Frivillig innsats i FOR ALLE! - satsingen: Treffer den, og virker den?",
  "2020-2025",     "Longtrends, Work package leader, Funder: Norwegian research council (NRC)",
  "2019-2024",     "New patterns - safe upringing, Researcher, Funder: NRC",
  "2014-2023",     "Linkage of youth@hordaland to national registries for education, Leader, Funder: NRC",
  "2014-2023",     "Linkage of youth@hordaland to national patient registry, Researcher, Funder: NRC",
  "2014-2020",     "EBU project, Researcher, Funder: NRC",
  "2016-2023",     "Project Perfect, Researcher, Funder: Extra foundation",
...
"36", "5", "Faculty of Psychology, University of Bergen, Norway",
)
...
__List of recent publications:__

<br><br><br><br><br>

```{r trackrefs, results='asis'}
# Selected publications:  
bib2<- ReadBib("tpubs_zot.bib",check= FALSE)
bib2 %>% as_tibble() %>% 
  # filter(!is.na(ids)) %>%
  arrange(desc(year)) %>% 
slice_head(n = 10) %>% 
