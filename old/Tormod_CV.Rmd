...
library(readxl)
library(dplyr)
formidling <- read_excel("/Users/tobo/Library/CloudStorage/OneDrive-UniversityofBergen/UiB/blog/static/files/Formidling.xlsx", sheet = "Ark2")
...
```{r thesis}
library(RefManageR)
bibliography_entries("/Users/tobo/Library/CloudStorage/OneDrive-UniversityofBergen/UiB/blog/static/files/tpubs_zot.bib") %>%
