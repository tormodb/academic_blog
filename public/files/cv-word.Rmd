...
## Authorships
first_lastauthor <- bibliography_entries("pubs_zot.bib") %>% # Change to file containing your own references!
...
n_firstauthor <- firstauthor %>% dplyr::filter(stringr::str_detect(first, "Bøe")) %>% count() # Replace Bøe with own surname.
n_lastauthor <- lastauthor %>% dplyr::filter(stringr::str_detect(last, "Bøe")) %>% count()    # Replace Bøe with own surname.
