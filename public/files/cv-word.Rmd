...
pinf <- tribble(
  ...
  "URL for personal website:", "https://tormodboe.netlify.com", "", "") 
...
curpos <- tribble(
  ...
  "2018-", "Associate Professor, Faculty of Psychology, University of Bergen, Norway",
...
"2017-",   "3", "PhD", "Faculty of Psychology, University of Bergen, Norway",
"2015-",   "14", "Master", "Faculty of Psychology, University of Bergen, Norway",
)
...
bib<- ReadBib("/Users/st06810/Dropbox/AkademiskCV/tpubs_zot.bib",check= FALSE)
...
```{r, results='asis'}
bib<- ReadBib("/Users/st06810/Dropbox/AkademiskCV/tpubs_zot.bib",check= FALSE)
bib %>% as_tibble() %>% filter(bibtype == "Thesis") %>% 
  arrange(desc(date)) %>% 
  as.BibEntry(.)
```
